...
# Function to solve the jumbled word problem and retrieve the secret message using brute-force
def solve_secret_message_brute_force(jumbled_words, word_list):
    secret_message = []
...
# Call the function to solve the problem and retrieve the secret message using brute-force
secret_message = solve_secret_message_brute_force(jumbled_words, word_list)
print("Secret Message (Brute-Force):", secret_message)
